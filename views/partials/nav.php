        ...
        <div class="hidden md:block">
            ...
            <?php if($_SESSION['user'] ?? false )  :?>
                <?php if ($_SESSION['user']['role']==='admin') : ?> 
                    ...
                    <a href="/manual_orders" class=" <?= isUrl("/manual_orders") ? "bg-gray-900 text-white" : "hover:bg-gray-700 text-gray-300 hover:text-white" ?> rounded-md px-3 py-2 text-sm font-medium">manual_orders</a>
