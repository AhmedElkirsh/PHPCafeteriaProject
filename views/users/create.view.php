...
<div class="w-full max-w-md p-4 bg-white rounded-md shadow-md mt-7">
        <h1 class="text-2xl font-bold text-gray-900 text-center mb-3">ADD USER</h1>
        <form action="/users" method="POST" enctype="multipart/form-data" class="space-y-4">
            <div>
                <label for="name" class="block text-sm font-medium text-gray-900">Name</label>
                <input id="name" name="name" type="text" autocomplete="name" required class="block w-full rounded-md border-gray-300 py-1 text-gray-900 shadow-sm focus:ring-indigo-600 sm:text-sm">
            </div>
            <div>
                <label for="email" class="block text-sm font-medium text-gray-900">Email address</label>
                <input id="email" name="email" type="email" required class="block w-full rounded-md border-gray-300 py-1 text-gray-900 shadow-sm focus:ring-indigo-600 sm:text-sm">
            </div>
            <div>
                <label for="password" class="block text-sm font-medium text-gray-900">Password</label>
                <input id="password" name="password" type="password" required class="block w-full rounded-md border-gray-300 py-1 text-gray-900 shadow-sm focus:ring-indigo-600 sm:text-sm">
            </div>
            <div>
                <label for="confirm" class="block text-sm font-medium text-gray-900">Confirm Password</label>
                <input id="confirm" name="passwordconfirm" type="password" required class="block w-full rounded-md border-gray-300 py-1 text-gray-900 shadow-sm focus:ring-indigo-600 sm:text-sm">
            </div>
            <div>
                <label for="role" class="block text-sm font-medium text-gray-900">Role</label>
                <select id="role" name="role" autocomplete="off" class="block w-full rounded-md border-gray-300 py-1 text-gray-900 shadow-sm focus:ring-indigo-600 sm:text-sm">
            ...
            <!-- <div>
                ...
                <input id="phonenumber" name="phonenumber" type="text" autocomplete="off" required class="block w-full rounded-md border-gray-300 py-1 text-gray-900 shadow-sm focus:ring-indigo-600 sm:text-sm">
            </div> -->
            <div>
            ...
            <ul>
                ...
                <?php if (isset($errors['passwordconfirm'])) : ?>
                    <li class="text-red-500 text-xs"><?= $errors['passwordconfirm'] ?></li>
                <?php endif; ?>
            ...
            <div>
                <button type="reset" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" name="reset">Reset</button>
            </div>
            <div>
