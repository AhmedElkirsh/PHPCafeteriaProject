    ...
    <div class="w-full max-w-md p-4 bg-white rounded-md shadow-md mt-7">
        ...
        <form action="/users" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input id="email" name="email" type="email" disabled  value ="<?= $user['email'] ?>" class="block w-full rounded-md border-gray-300 py-1 text-gray-900 shadow-sm focus:ring-indigo-600 sm:text-sm">
            </div>
            <div>
            ...
            <div id="passwordFields" class="hidden">
                ...
                <div>
                    ...
                    <input id="confirm" name="confirm_password" type="password" class="block w-full rounded-md border-gray-300 py-1 text-gray-900 shadow-sm focus:ring-indigo-600 sm:text-sm">
                </div>
            </div>
